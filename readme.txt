This is an emplementation of a solution to the test task from Veeam Software by Goncalo Quintino.

The program receives the following arguments from the command line:
...
- Finds all the folders inside the original folder and creates them in the replica if necessary
- Verifies what files need to be copied or deleted in the replica by comparing md5 hashes
...
- The program records the time spent in the process of synchronization so that the time interval stays constant

Notes:
- The program has tests in some of the functions to exemplify the importance of testing the code
